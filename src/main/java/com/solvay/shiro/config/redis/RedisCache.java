package com.solvay.shiro.config.redis;

import com.solvay.shiro.config.exception.PrincipalIdNullException;
import com.solvay.shiro.config.exception.PrincipalInstanceException;
 ...
 * @author: solvay
 * @date: 2018/6/22
 * @description: 参考 redis-redis 开源项目 Git地址 https://github.com/alexxiyang/shiro-redis
 */
